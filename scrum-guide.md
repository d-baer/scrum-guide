...
This HTML version of the Scrum Guide is a direct port of the July 2016 version available [as a PDF here](http://scrumguides.org/docs/scrumguide/v2016/2016-Scrum-Guide-US.pdf).
...
The history of Scrum is already considered long. To honor the first places where it was tried and refined, we recognize Individual, Inc., Fidelity Investments, and IDX (now GE Health).
